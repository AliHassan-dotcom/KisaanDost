...
void main() {
  group('AiResearchAgent Unit & Verification Tests', () {
    ...
    test('Scenario 1: Weather query resolves from dataset and provides details', () async {
    ...
    test('Scenario 2: Pest query resolves from dataset and provides advice', () async {
      final answer = await agent.answerQuestion('Wheat mein keeda lag گیا, kya spray karun?');
    ...
    test('Scenario 3: Market query resolves from dataset and provides rate', () async {
    ...
    test('Scenario 4: Non-dataset crop disease query provides disease information', () async {
    ...
    test('Scenario 5: Out of domain unknown query gracefully returns polite fallback', () async {
      ...
      expect(answer.contains('Maaf karein'), isTrue);
    });
